...
const getLanguageContent = (language) => {
    const contentMap = {
        ...
        hindi: {
            ...
            typewriterLines: [
                "प्रभावशाली संवाद की कला में महारत हासिल करें।",
                "बोर्डरूम से लेकर कक्षा तक, अंग्रेज़ी हर दरवाज़ा खोलती है।",
                "धाराप्रवाह बोलना सीखें। आत्मविश्वास बढ़ाएँ। अपना भविष्य बनाएं।",
                "स्पष्टता से बोलें। सटीकता से लिखें। भाषा के साथ नेतृत्व करें।",
            ],
            flag: "🇮🇳",
            accentColor: "#EB6664",
        ...
        french: {
            ...
            typewriterLines: [
                "Maîtrisez l'art de la communication éloquente.",
                "Des salles de réunion aux salles de classe, l’anglais ouvre toutes les portes.",
                "Développez votre fluidité. Renforcez votre confiance. Construisez votre avenir.",
                "Parlez avec clarté. Écrivez avec précision. Dirigez avec la langue.",
            ],
            flag: "🇫🇷",
            accentColor: "#EB6664",
        ...
        german: {
            ...
            typewriterLines: [
                ...
                "Vom Sitzungssaal bis zum Klassenzimmer öffnet Englisch jede Tür.",
                "Bauen Sie Sprachflüssigkeit auf. Gewinnen Sie Selbstvertrauen. Gestalten Sie Ihre Zukunft.",
                "Sprechen Sie klar. Schreiben Sie präzise. Führen Sie mit Sprache.",
            ],
            flag: "🇩🇪",
            accentColor: "#EB6664",
        ...
        spanish: {
            ...
            typewriterLines: [
                ...
                "Desde las salas de juntas hasta las aulas, el inglés abre todas las puertas.",
                "Desarrolla fluidez. Construye confianza. Construye tu futuro.",
                "Habla con claridad. Escribe con precisión. Lidera con el lenguaje.",
            ],
            flag: "🇪🇸",
            accentColor: "#EB6664",
        ...
        telugu: {
            ...
            quoteEnglish: "— Federico Fellini",
            typewriterLines: [
                "స్పష్టమైన సంభాషణ కళలో నైపుణ్యం సాధించండి.",
                "బోర్డు గదుల నుంచి తరగతి గదుల వరకు, ఇంగ్లీష్ ప్రతి తలుపు తెరుస్తుంది.",
                "ప్రవాహంగా మాట్లాడటం నేర్చుకోండి. ఆత్మవిశ్వాసం పెంపొందించుకోండి. మీ భవిష్యత్తును నిర్మించండి.",
                "స్పష్టంగా మాట్లాడండి. ఖచ్చితంగా వ్రాయండి. భాషతో నాయకత్వం వహించండి.",
            ],
            flag: "🇮🇳",
            accentColor: "#EB6664",
        ...
        tamil: {
            ...
            quoteEnglish: "— Federico Fellini",
            typewriterLines: [
                "தெளிவான தொடர்பின் கலைவை கற்றுக்கொள்ளுங்கள்.",
                "மாநாட்டு அறைகளில் இருந்து வகுப்பறைகள் வரை, ஆங்கிலம் அனைத்து கதவுகளையும் திறக்கிறது.",
                "தெளிவாக பேச கற்றுக்கொள்ளுங்கள். நம்பிக்கையை வளர்த்துக்கொள்ளுங்கள். உங்கள் எதிர்காலத்தை உருவாக்குங்கள்.",
                "தெளிவாக பேசுங்கள். துல்லியமாக எழுதுங்கள். மொழியுடன் வழிநடத்துங்கள்.",
            ],
            flag: "🇮🇳",
            accentColor: "#EB6664",
            bgGradient: "from-red-950 via-slate-900 to-yellow-950",
        ...
        kannada: {
            ...
            quoteEnglish: "— Federico Fellini",
            typewriterLines: [
                "ಸ್ಪಷ್ಟ ಸಂವಹನದ ಕಲೆಯನ್ನು ಮಾಸ್ಟರ್ ಮಾಡಿ.",
                "ಬೋರ್ಡ್ ರೂಮ್‌ಗಳಿಂದ ತರಗತಿ ಕೊಠಡಿಗಳವರೆಗೆ, ಇಂಗ್ಲಿಷ್ ಎಲ್ಲಾ ಬಾಗಿಲುಗಳನ್ನು ತೆರೆಯುತ್ತದೆ.",
                "ಸರಳವಾಗಿ ಮಾತನಾಡಲು ಕಲಿಯಿರಿ. ಆತ್ಮವಿಶ್ವಾಸವನ್ನು ಬೆಳೆಸಿರಿ. ನಿಮ್ಮ ಭವಿಷ್ಯವನ್ನು ನಿರ್ಮಿಸಿ.",
                "ಸ್ಪಷ್ಟವಾಗಿ ಮಾತನಾಡಿ. ಖಚಿತವಾಗಿ ಬರೆಯಿರಿ. ಭಾಷೆಯೊಂದಿಗೆ ನಾಯಕತ್ವ ವಹಿಸಿ.",
            ],
            flag: "🇮🇳",
            accentColor: "#EB6664",
        ...
        malayalam: {
            ...
            quoteEnglish: "— Federico Fellini",
            typewriterLines: [
                "വ്യക്തമായ ആശയവിനിമയത്തിന്റെ കല കൈവരിക്കുക.",
                "ബോർഡ്റൂമുകളിൽ നിന്ന് ക്ലാസ്‌റൂമുകളിലേക്ക്, ഇംഗ്ലീഷ് എല്ലാ വാതിലുകളും തുറക്കുന്നു.",
                "സ്വാഭാവികമായി സംസാരിക്കുക. ആത്മവിശ്വാസം വളർത്തുക. നിങ്ങളുടെ ഭാവി നിർമ്മിക്കുക.",
                "വ്യക്തമായി സംസാരിക്കുക. കൃത്യമായി എഴുതുക. ഭാഷയിലൂടെ നേതൃത്വം നൽകുക.",
            ],
            flag: "🇮🇳",
            accentColor: "#EB6664",
        ...
        sanskrit: {
            ...
            quoteEnglish: "— Federico Fellini",
            typewriterLines: [
                "सुस्पष्टसंवादकलेषु प्रवीणतां प्राप्नुहि।",
                "सभागृहात् पाठशालां यावत्, आङ्ग्लभाषा सर्वद्वाराणि उद्घाटयति।",
                "प्रवाहपूर्णभाषणं साधय। आत्मविश्वासं वर्धय। स्वभविष्यं निर्मातुम्।",
                "स्पष्टं वद। यथार्थं लिख। भाषया नेतृत्वं कुरु।",
            ],
            flag: "🕉️",
            accentColor: "#EB6664",
