  ...
  return (
    <section style={{
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
        <div style={{ position: "absolute", width: 400, height: 400, borderRadius: "50%", filter: "blur(100px)", background: `radial-gradient(circle, ${RED}10, transparent)`, top: "-15%", left: "-8%" }} />
        <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", filter: "blur(80px)", background: `radial-gradient(circle, ${YELLOW}12, transparent)`, bottom: "0%", right: "-5%" }} />
        {heroBubbles.map((b, i) => (
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {testimonials.map((t, i) => (
              <motion.div key={i}
                ...
                animate={{ width: i === activeTestimonial ? 24 : 8, background: i === activeTestimonial ? t.accentColor : RULED }}
